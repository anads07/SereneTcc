...
const ProfileScreen = ({ navigation }) => {
  ...
  // função auxiliar: obter id do usuário
  ...
  // função auxiliar: buscar dados do perfil
  ...
  // efeito: carregar dados do perfil ao focar na tela
  useFocusEffect(
    useCallback(() => {
  ...
  // função principal: salvar alterações no perfil
...
const styles = StyleSheet.create({
  ...
  valueContainer: {
    ...
    width: '100%',
    alignItems: 'center',
    borderWidth: screenWidth > 400 ? 2 : 1.5,
    borderColor: '#5691de', 
    minHeight: screenWidth > 400 ? 16 + 16 + 4 : 14 + 14 + 3,
    justifyContent: 'center', 
  },
  valueText: {
    fontSize: screenWidth > 400 ? (screenWidth > 500 ? 18 : 17) : 15,
